...
create index staff_access_requests_status_idx on public.staff_access_requests (status, created_at desc);
...
create index issues_department_idx on public.issues (department_id, status);
...
create index assignments_issue_idx on public.assignments (issue_id);
...
create index resolution_evidence_issue_idx on public.resolution_evidence (issue_id);
...
create index ai_assessments_issue_idx on public.ai_assessments (issue_id);
